...
public class Recieve extends Activity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.activity_recieve, menu);
    ...
    public void startMessageActivity(View view) {
        Intent clientStartIntent = new Intent(this, MessageActivity.class);
    ...
    public void startServer(View view) {
        ...
        {
            //Create new thread, open socket, wait for connection, and proj file
