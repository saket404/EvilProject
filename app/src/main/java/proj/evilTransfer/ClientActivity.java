...
public class ClientActivity extends Activity {
	...
	public void startServerActivity(View view) {
		Intent clientStartIntent = new Intent(this, ServerActivity.class);
    	...
    	if (resultCode == Activity.RESULT_OK && requestCode == fileRequestID) {
    		...
    		if(targetDir.isFile())
    		{
    			if(targetDir.canRead())
    			{
    				...
    				setTargetFileStatus(targetDir.getName() + " selected for file sending");
    		...
    		{
				filePathProvided = false;
    			setTargetFileStatus("You cannot send a directory, please select a single file");
    		}
    ...
    public void sendFile(View view) {
    	...
    	//Only try to send file if there isn't already a proj active
    	if(!transferActive)
    	{
	        if(!filePathProvided)
	        {
	        ...
	        else
	        {
	        	...
	        	clientServiceIntent.putExtra("clientResult", new ResultReceiver(null) {
		    	    ...
		    	    protected void onReceiveResult(int resultCode, final Bundle resultData) {
		    	    	...
		    	    	{
			    	        if (resultData == null) {
			    	           //Client service has shut down, the proj may or may not have been successful. Refer to message
			    	        	transferActive = false;				    	        				    	       			    	        				    	        			    	        	
			    	        }
			    	        else
			    	        {    	        	
